...
void *memmove(void *dest, const void *src, size_t count) {
  ...
  if (dest == nullptr || src == nullptr || count == 0) {//warning
...
// open
template <typename T>
void openIOps(IOps<T> **op, const char *file, const char *mode) {
...
//create queue
template <typename T>
void creater(Queue<T> **q){

}
//close queue
template <typename T>
void cleaner(Queue<T> **q){
